        ...
        <div className="text-gray-100" style={{
                            ...
                            {[
                                ...
                                <button
                                    ...
                                    className={`text-lg font-medium nav-link relative ${
                                        activeSection === item.id ? 'text-teal-600' : 'hover:text-teal-600'
            ...
            <main>
                ...
                <section 
                    ...
                    style={{ 
                        background: 'linear-gradient(135deg, rgba(13, 148, 136, 0.15) 0%, rgba(15, 118, 110, 0.1) 100%)',
                        paddingTop: '80px' 
                    }}
                >
                    <div className="section-container" style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 1.5rem' }}>
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                            ...
                            >
                                ...
                                <p className="text-xl mb-8 text-gray-300">
                                    We specialize in professional scrap buying, offering fair pricing, eco-friendly recycling, and smooth transactions.
                                </p>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                            {services.map((service, index) => (
                                <motion.div
                                    ...
                                    className="bg-gray-800 rounded-xl p-8 card-hover hover:transform hover:-translate-y-2 transition-all duration-300"
                                >
                ...
                >
                    <div className="section-container" style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 1.5rem' }}>
                        <h2 className="text-5xl font-bold mb-12 text-center">About <span className="text-teal-600">Us</span></h2>
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
                            <motion.div
                                ...
                                transition={{ duration: 0.8 }}
                            >
                                <h3 className="text-3xl font-bold mb-6 text-yellow-500">What Sets Our Business Apart for Your Selection</h3>
                        ...
                        >
                            <h3 className="text-3xl font-bold mb-8 text-center text-yellow-500">Experience & Expertise</h3>
                ...
                >
                    <div className="section-container" style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 1.5rem' }}>
                        <h2 className="text-5xl font-bold mb-4 text-center">Our <span className="text-teal-600">Products</span></h2>
                ...
                >
                    <div className="section-container" style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 1.5rem' }}>
                        <h2 className="text-5xl font-bold mb-4 text-center">Our <span className="text-teal-600">Gallery</span></h2>
                        <p className="text-xl text-gray-400 mb-12 text-center max-w-3xl mx-auto">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {galleryImages.map((image, index) => (
                                <motion.div
                                    ...
                                    transition={{ duration: 0.8, delay: index * 0.1 }}
                                    className="relative overflow-hidden rounded-xl gallery-img cursor-pointer hover:transform hover:scale-105 transition-all duration-300"
                ...
                >
                    <div className="section-container" style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 1.5rem' }}>
                        <h2 className="text-5xl font-bold mb-4 text-center">Client <span className="text-teal-600">Testimonials</span></h2>
                        <p className="text-xl text-gray-400 mb-12 text-center max-w-3xl mx-auto">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-12">
                            <motion.div
                                ...
                                className="bg-gray-800 rounded-xl p-8 hover:transform hover:-translate-y-2 transition-all duration-300"
                            >
                                <div className="flex items-center mb-6">
                ...
                >
                    <div className="section-container" style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 1.5rem' }}>
                        <h2 className="text-5xl font-bold mb-4 text-center">Contact <span className="text-teal-600">Us</span></h2>
                        <p className="text-xl text-gray-400 mb-12 text-center max-w-3xl mx-auto">
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                            ...
                            <motion.div
                                ...
                                transition={{ duration: 0.8 }}
                            >
                                <h3 className="text-3xl font-bold mb-8 text-yellow-500">Send Us a Message</h3>
                            ...
                            >
                                ...
                                <div className="mt-8 bg-gray-800 rounded-xl p-6">
                                    <h4 className="text-xl font-bold mb-4 text-yellow-500">Business Hours</h4>
                ...
                {/* CTA Section */}
                <section className="bg-gradient-to-r from-teal-600 to-teal-700 section-padding" style={{ padding: '5rem 0' }}>
                    <div className="section-container" style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 1.5rem' }}>
                        <div className="text-center">
                ...
                <div className="section-container" style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 1.5rem' }}>
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
                        ...
                        <div>
                            ...
                            <ul className="space-y-3">
                                {services.map((service, index) => (
                                    <li key={index} className="text-gray-400">{service.title}</li>
                                ))}
                            </ul>
                        </div>
